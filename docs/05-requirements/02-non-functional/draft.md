...
|------|------|----------|------------|--------|
| NFR-001 | 간단한 명령의 End-to-end 응답 시간 | LAT | FR-001, FR-008 | 3.4.1 |
| NFR-002 | 복잡한 태스크 첫 피드백 시간 | LAT | FR-008 | 3.4.1 |
