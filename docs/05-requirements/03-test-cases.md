...
> **범위 조정 (2026-06-04)**: 대응 UC/NFR 삭제에 따라 **TC-UC-09·13·14·22, TC-NFR-13·16**을 삭제(결번 유지)했다.
...
### TC-UC-09 *(삭제됨 — UC-09 멀티프로필 범위 제외)*
...
### TC-UC-13 *(삭제됨 — UC-13 페이지 인식 메커니즘 이관)*

### TC-UC-14 *(삭제됨 — UC-14 조건부 활성화 범위 제외)*
...
### TC-UC-17 — UC-17 자격증명 비노출 사용 및 권한 최소화
...
### TC-UC-22 *(삭제됨 — UC-22 / 비자동화 대체 경로 제거)*
